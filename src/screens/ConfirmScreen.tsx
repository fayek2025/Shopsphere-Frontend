...
import { fetchPaymentGatewayURL } from "../api";
...
const confirmScreen = ({
  ...
  const handlePayment = async () => {
    try {
      const gatewayUrl = await fetchPaymentGatewayURL(); // Fetch the payment gateway URL
      Alert.alert(
        "Redirecting",
        ...
        [
          {
            text: "OK",
            onPress: () => Linking.openURL(gatewayUrl), // Open URL in browser
          },
        ]
      );
    } catch (error: any) {
